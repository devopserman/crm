...
if(USER_LOGGED) {
	...
	$sql = mysql_query('SELECT * FROM user_to_project WHERE active=1 AND project_id='.$id) or die(mysql_error());
						...
						echo'<table border="0" style="border-collapse: collapse; width: 100%;">
							<tbody>
								<tr>
									...
									<td style="width: 1%;"><span class="button_blue"><a href="index.php?cat=usr&op=usr_edit_prj&id='.$_GET[id].'&user='.$data[uid].'">></a></span></td>
