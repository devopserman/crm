				...
				<table border="0" style="border-collapse: collapse; width: 100%; ">
					<tbody>
						<tr>
							...
							<td style="width: auto;"><b><a href="index.php?cat=prj&op=show&id=' .$data['pr_id']. '">'.$data['pr_id'].'. '  .$data['pr_name'] . '</a></b> '.$mark.'
									<table border="0" style="border-collapse: collapse; width: 100%;">
									<tbody>
									<tr>
									<td style="width: 50%;"><p  class="sub_content">'.$pr_firm.'</p></td>
									<td align="right" style="width: 50%; halign:right; ">'.$mark_status.'</td>
									</tr>
									<tr>
									<td style="width: 50%;"><p class="sub_content"><a href="index.php?cat=usr&op=show&id='.$data['pr_lid'].'">'.$pr_lid.'</a></p></td>
									<td style="width: 50%;"><p class="mess_date" align="right" >Обновлено: '.$dateupdate.'</p></td>
									</tr>
									</tbody>
									</table>
							</td>
