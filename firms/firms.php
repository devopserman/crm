...
include "auth.php";  
	...
	{  
		...
		case 'frm_add'  		: include "frm_add.php"; break;
		case 'frm_edit'  		: include "frm_edit.php"; break;
		case 'firm_to_add' 	 	: include "action.php"; break;
		case 'firm_to_edit'  	: include "action.php"; break;
		case 'firm_to_del' 	 	: include "action.php"; break;	
